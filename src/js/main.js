// Toggle menu button
if (document.querySelector("#toggleMenu") && document.querySelector("#mainMenu")) {
...
if (document.querySelector('[data-action="toggle"]')) {
    ...
    [...toggleButtons].forEach(toggleButton => {
        ...
        toggleButton.addEventListener("click", function () {
            ...
            if (document.querySelector(`[data-name="${data_name}"][data-toggle="${data_target}"]`)) {
                const targets = document.querySelectorAll(`[data-name="${data_name}"][data-toggle="${data_target}"]`);
                const images = document.querySelectorAll(`[data-toggle][data-name="${data_name}"]`);
